...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/RJNetworking-Swift/RJNetworking_Swift.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/RJUtils_Swift/RJUtils_Swift.framework"
